    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('right_answers', models.CharField(blank=True, help_text='Через запятую без пробелов, например: "1,2,3,сто твадцать три".', max_length=255, null=True, verbose_name='Правильные ответы')),
                ('points', models.FloatField(blank=True, null=True, verbose_name='Баллы')),
                ('img', models.ImageField(blank=True, null=True, upload_to='tasks/img/%Y/%m/%d', verbose_name='Картинка')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(blank=True, null=True, upload_to='tests/img/%Y/%m/%d', verbose_name='Картинка')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('points', models.FloatField(blank=True, null=True, verbose_name='Баллы')),
                ('ans', models.ManyToManyField(to='tests.answer_from_user', verbose_name='Ответы')),

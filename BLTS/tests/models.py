...
class Task(models.Model):
    ...
    right_answers = models.CharField(max_length=255, verbose_name='Правильные ответы', help_text='Через запятую без пробелов, например: "1,2,3,сто твадцать три". Поставьте 0 если автопровека будет выключена')
...
class Tests_for_user(models.Model):
    ...
    def __str__(self):
        return f'{self.user.username[:10]} - {self.test.title[:15]}'
